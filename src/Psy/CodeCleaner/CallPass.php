...
class CallPass extends NamespaceAwarePass
{
     ...
     * @param array  $variables The array of all defined variables
     *
     * @return mixed
     */
    public static function checkVariable($name, array $variables)
    {
        if (!array_key_exists((string) $name, $variables)) {
    ...
    protected function parseArguments(array $args)
    {
        ...
        foreach ($args as $arg) {
            ...
            if ($value instanceof Variable) {
                ...
                $arguments[] = new ArrayItem($value, null);
            }
